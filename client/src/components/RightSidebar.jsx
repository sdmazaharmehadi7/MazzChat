  ...
  return selectedUser &&(
    ...
    ${selectedUser? "max-md:hidden" : ""}`}>
        ...
        <div className='pt-16 flex flex-col items-center gap-2 text-xs font-light mx-auto'>
          <img src={selectedUser?.profilePic || assets.arrow_icon} alt="" 
          className='w-20 aspect-[1] rounded-full'/>
        ...
        <div className='px-5 text-xs'>
            <p>Media</p>
            <div className='mt-2 max-h-[230px] overflow-y-scroll grid grid-cols-2 gap-4 opacity-80'>
